...
# Word Counts (underscore infront makes internal to python package)
...
#Count if Numeric Digits Are Present 
...
def _remove_common_words(x, n=20):
	...
	#removes the top 20 from dataframe
...
def _remove_rarewords(x, n=20):
	...
	#removes the last 20 from dataframe
	fn = freq_comm.tail(n)
